...
public:
    ...
    void update(RenderWindow& window); // m�thode pour d�placer le projectile
    bool isAlive(RenderWindow& window); // m�thode pour v�rifier si le projectile est toujours dans la fen�tre
